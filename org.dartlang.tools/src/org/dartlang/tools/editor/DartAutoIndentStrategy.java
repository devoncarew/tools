...
public class DartAutoIndentStrategy extends DefaultIndentLineAutoEditStrategy {
  ...
  /**
   * Returns the bracket value of a section of text. Closing brackets have a value of -1 and open
   * brackets have a value of 1.
   * 
   * @param document - the document being parsed
   ...
   * @throws BadLocationException in case <code>position</code> and <code>end</code> are invalid in
   *           the document
   */
  ...
  /**
   * Returns the position of the <code>character</code> in the <code>document</code> after
   * <code>position</code>.
   * 
   * @param document - the document being parsed
